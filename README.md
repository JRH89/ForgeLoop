...
- [x] Responsive React operator console with intake queue, task DAG/attempts, live polling, screenshot and redacted-log evidence, acceptance gates, budgets, analytics, harness/policy administration, audit timeline, approval/cancel/retry controls, GitHub PR links, and a responsive in-app operator handbook.
