...
The runner does not yet clone repositories or execute tools. It can perform the protocol-level acknowledgement of an explicitly supplied lease, but task discovery and execution are deliberately deferred until isolation is verified.
