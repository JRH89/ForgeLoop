...
public class FeatureRun {
  ...
  private double budgetUsd; private String harnessProfile; private int policyRevision;
  ...
  public FeatureRun(String organizationId,String repository,String sourceRef,String title,String specification,double budgetUsd,String harnessProfile,int policyRevision) { this.organizationId=organizationId; this.repository=repository; this.sourceRef=sourceRef; this.title=title; this.specification=specification; this.budgetUsd=budgetUsd; this.harnessProfile=harnessProfile; this.policyRevision=policyRevision; this.state=RunState.RECEIVED; this.createdAt=Instant.now(); }
  ...
  public String getId(){return id;} public String getOrganizationId(){return organizationId;} public String getRepository(){return repository;} public String getSourceRef(){return sourceRef;} public String getTitle(){return title;} public String getSpecification(){return specification;} public double getBudgetUsd(){return budgetUsd;} public String getHarnessProfile(){return harnessProfile;} public int getPolicyRevision(){return policyRevision;} public RunState getState(){return state;} public String getCreatedAt(){return createdAt.toString();} public List<DeliveryTask> getTasks(){return List.copyOf(tasks);} public List<VerificationGate> getGates(){return List.copyOf(gates);} public List<AcceptanceCriterion> getCriteria(){return List.copyOf(criteria);}
}
