...
@Controller public class PlatformConfigurationController{
 ...
 @MutationMapping public OrganizationPolicy configureOrganizationPolicy(@Argument OrganizationPolicyInput input){return platform.configurePolicy(input.maxRunBudgetUsd(),input.maxParallelTasks(),input.allowedProviders(),input.requireHumanApproval());}
