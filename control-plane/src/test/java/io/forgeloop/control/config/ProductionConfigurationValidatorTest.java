...
class ProductionConfigurationValidatorTest {
    ...
    @Test void acceptsSafeProductionRequirements() {
        assertDoesNotThrow(() -> new ProductionConfigurationValidator("production", "https://issuer.example", "forgeloop-api", "secret", "jdbc:postgresql://db/forgeloop", "validate", "s3://forgeloop-evidence", "a".repeat(32), "123", "private-key", "b".repeat(32)).validate());
    }
}
