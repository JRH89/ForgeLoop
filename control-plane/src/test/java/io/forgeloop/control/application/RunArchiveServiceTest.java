...
class RunArchiveServiceTest {
    @Test void mutationRequiresRoleAndTenantLookupAndAuditsSuccess() {
        ...
        new RunArchiveService(runs,operators,audit,mock(io.forgeloop.control.domain.GithubPublicationRepository.class),mock(io.forgeloop.control.integrations.github.GithubPublicationStatusService.class)).archive("id",true);
    ...
    @Test void deniedTenantCannotMutateOrAudit() {
        ...
        assertThrows(IllegalStateException.class,()->new RunArchiveService(runs,operators,audit,mock(io.forgeloop.control.domain.GithubPublicationRepository.class),mock(io.forgeloop.control.integrations.github.GithubPublicationStatusService.class)).archive("other-org",true));
    ...
    @Test void viewerCannotReachRunLookup() {
        ...
        assertThrows(org.springframework.security.access.AccessDeniedException.class,()->new RunArchiveService(runs,operators,audit,mock(io.forgeloop.control.domain.GithubPublicationRepository.class),mock(io.forgeloop.control.integrations.github.GithubPublicationStatusService.class)).archive("id",true));
